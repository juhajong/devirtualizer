...
if __name__ == "__main__":
    ...
    func_start, func_end = get_func_address(filename)
    ...
    print "func_start: {}, func_end: {}".format(hex(func_start), hex(func_end))
